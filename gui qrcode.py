...
import os
root = Tk()
root.title("Aplikasi Pembuat QR CODE")
...
s.theme_use("style")
# add tabs
note.add(frame1,text="Buat QR Code")
note.add(frame2,text="Baca QR Code")
...
data_label = Label(frame1, text='Paste URL:', font=('ariel 15 bold'), bg='white')
data_label.place(x=61, y=330)
save_label = Label(frame1, text='Beri Nama:', font=('ariel 15 bold'), bg='white')
...
btn1 = Button(frame1, text="Convert", bg='black', fg='gold', font=('ariel 15 bold'), relief=GROOVE, command=generate)
...
btn2 = Button(frame2, text="Pilih Gambar", bg='black', fg='gold', font=('ariel 15 bold'), relief=GROOVE, command=selected)
btn2.pack(side=LEFT, padx=50, pady=5)
btn3 = Button(frame2, text="Keluar", width=12, bg='black', fg='gold', font=('ariel 15 bold'), relief=GROOVE, command=root.destroy)
